...
namespace Canvas_Interface.View
{
    ...
    /// </summary>
    public sealed partial class CourseStudentView : Page
    {
        ...
        {
            InstructorViewModel.SelectedCourse.Roster.Add((DataContext as InstructorViewModel).SelectedStudent);
        }

        private void RemoveStudent(object sender, RoutedEventArgs e)
        {
            InstructorViewModel.SelectedCourse.Roster.Remove((DataContext as InstructorViewModel).SelectedStudent);
        }
